    ...
    CREATE OR REPLACE FUNCTION encrypt_${tablePrefix}${eventTable}(data jsonb, annotations jsonb, encryption_key uuid)
      ...
      */
      ...
      BEGIN
        ...
        LOOP
           -- data[_key] = pgp_sym_encrypt(data[_key], encryption_key::text, 'compress-algo=1, cipher-algo=aes256')::text
        END LOOP;
    ...
    CREATE OR REPLACE FUNCTION decrypt_${tablePrefix}${eventTable}(data jsonb, annotations jsonb, encryption_key uuid)
      ...
      */
      ...
      BEGIN
        ...
        LOOP
           -- data[_key] = pgp_sym_decrypt(data[_key], encryption_key::text, 'compress-algo=1, cipher-algo=aes256')
        END LOOP;
